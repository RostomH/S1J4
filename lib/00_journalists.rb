...
#2
puts journalists.count {|x| x[/[0-9]/]}

#3
puts journalists.count {|x| /aude/.match(x.downcase)} 

#4

puts journalists.count{|x| x[/^@[A-Z]/]}
...
puts journalists.count {|x| x.include?("_")}

#7
puts journalists.sort_by {|i| i.downcase}

#8


#9
puts journalists.find_index {|x| x.match("@epenser")}
